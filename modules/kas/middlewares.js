...
const KasMiddlewareCreate = LibValidationsMiddleware(
  ...
  LibValidationFields.NumberField({ field: "pemasukan", required: false, minLength: 0 }),
  LibValidationFields.NumberField({ field: "pengeluaran", required: false, minLength: 0 }),
